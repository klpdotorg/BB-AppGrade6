...
Game.userprogress2.prototype={
    ...
    gotoAddNSMCTopics:function(game){
        ...
        this.ratioandproportionTreeTxt = this.add.text(175, 520, "ಅನುಪಾತ ಮತ್ತು ಅನುಪಾತ"); // window.selctedLang.ratioandproportionTitle
    ...
    gotoAddALMCTopics:function(game){
        ...
        this.operationsTreeTxt = this.add.text(175, 200, "ವೇರಿಯಬಲ್ ಮತ್ತು ಸಮೀಕರಣ");//window.selctedLang.algebraTitle

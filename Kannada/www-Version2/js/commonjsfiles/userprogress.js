...
Game.userprogress.prototype={
	...
	addScrollingtouserprogress:function(game, completedText)
	{
    	...
    	this.numberSystemsTreeTxt = this.add.text(160, 175, window.selctedLang.McTopicText1);
    	...
    	this.algebraTreeTxt = this.add.text(160, 270, window.selctedLang.McTopicText2);
    	...
    	this.geometryTreeTxt = this.add.text(160, 365, window.selctedLang.McTopicText4);//465-y
		...
		//_this.graphicsBg.addChild(this.ratioandProportionTree);
		//_this.graphicsBg.addChild(this.ratioandProportionTreeTxt);
		_this.graphicsBg.addChild(this.geometryTree);
		_this.graphicsBg.addChild(this.geometryTreeTxt);
		// _this.graphicsBg.addChild(this.decimalsTree);
		// _this.graphicsBg.addChild(this.decimalsTreeTxt);
		...
		// _this.graphicsBg.addChild(this.ratioandProportionPrgress);
		// _this.graphicsBg.addChild(this.ratioandProportionPrgressTxt);
		//_this.graphicsBg.addChild(this.ratioandProportionPrgressTotalTxt);
		...
		// _this.graphicsBg.addChild(this.decimalsPrgress);
		// _this.graphicsBg.addChild(this.decimalsPrgressTxt);
		// _this.graphicsBg.addChild(this.decimalsPrgressTotalTxt);

...
Game.userprogress.prototype={
	...
	afterDataFetched:function(game){
		...
		this.algebraPersent = Math.round((parseInt(this.responseData.PALG)/this.algebraTotal)*100);
	...
	addScrollingtouserprogress:function(game, completedText)
	{
    	...
    	this.algebraTree.scale.setTo(0.6,0.38);
    	...
    	this.geometryTree.scale.setTo(0.6,0.38);

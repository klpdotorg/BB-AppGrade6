...
Game.downloadData.prototype = {
    ...
    create: function (game) {
        ...
        _this.basePath = cordova.file.externalRootDirectory + "Android/data/com.Akshara.ENBBplusplus/Files/Download/.gameFilesBB++V10_2/www/";

        _this.fullSize = 125433088;

        _this.zipFiles = [["Assets1.zip", 565373], ["Assets2.zip", 25572815], ["Assets4.zip", 66338462], ["questionSounds.zip", 29272691], ["sounds.zip", 3683747]];
        ...
        _this.fileCheck = [
            [_this.basePath + "questionSounds/ALAS-01-G6/ENG", localStorage.getItem("language") + "/questionSounds.zip"],
        ...
        var titleTxt = game.add.text(game.world.centerX, 45, "English BB++");
    ...
    checkIfAllAssetsPresent: function () {
        if (_this.counter < _this.fileCheck.length)
            ...
            window.baseUrl = cordova.file.externalRootDirectory + "Android/data/com.Akshara.ENBBplusplus/Files/Download/.gameFilesBB++V10_2/www/";//cordova.file.externalDataDirectory + 

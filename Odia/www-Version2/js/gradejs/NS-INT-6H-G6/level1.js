...
Game.NS_INT_6H_G6level1.prototype =
{
    ...
    showBoxSelection: function () {
        ...
        _this.time.events.add(3500, () => {
            console.log("select Q4 show drag");
            _this.askQn4();
    ...
    showDrag: function () {
        ...
        _this.time.events.add(2500, () => {
            ...
            _this.hand.destroy();
            console.log("select Q5 hand destroy");
            _this.askQn5();
    ...
    dropFunc: function (sign) {
        ...
        if ((sign.x >= 740 && sign.x <= 870) && (sign.y >= 240 && sign.y <= 335)) {
            ...
            if (_this.count1 <= 0 && _this.repeatQues == true) {
                ...
                console.log("select Q5 repeat que");
                _this.askQn5();
            }
            _this.qn_flag = 5;
    ...
    askdemo1: function () {
        ...
        _this.demoVo1src.setAttribute("src", window.baseUrl + "questionSounds/NS-INT-6H-G6/" + _this.languageSelected + "/NS-INT-6-G6 demo 1.mp3");
    ...
    askQn2: function () {
        ...
        _this.Question2src.setAttribute("src", window.baseUrl + "questionSounds/NS-INT-6H-G6/" + _this.languageSelected + "/NS-INT-6-G6 a.mp3");
    ...
    askQn3: function () {
        ...
        _this.Question2 = document.createElement('audio');
        _this.Question2src = document.createElement('source');
        _this.Question2src.setAttribute("src", window.baseUrl + "questionSounds/NS-INT-6H-G6/" + _this.languageSelected + "/NS-INT-6-G6 c.mp3");
        _this.Question2.appendChild(_this.Question2src);
        _this.Question2.play();
    },
    askQn4: function () {
        ...
        _this.Question2 = document.createElement('audio');
        _this.Question2src = document.createElement('source');
        _this.Question2src.setAttribute("src", window.baseUrl + "questionSounds/NS-INT-6H-G6/" + _this.languageSelected + "/NS-INT-6-G6 b.mp3");
        _this.Question2.appendChild(_this.Question2src);
        _this.Question2.play();
    },
    askQn5: function () {

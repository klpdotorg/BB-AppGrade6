...
Game.downloadData.prototype = {
    ...
    create: function (game) {
        ...
        _this.fullSize = 144843098;

        _this.zipFiles = [["Assets1.zip", 565373], ["Assets2.zip", 25572815], ["Assets4.zip", 66338462], ["questionSounds.zip", 48682701], ["sounds.zip", 3683747]];
        ...
        _this.fileCheck = [
            [_this.basePath + "questionSounds/ALAS-01-G6/ODI", localStorage.getItem("language") + "/questionSounds.zip"],
        ...
        var titleTxt = game.add.text(game.world.centerX, 45, "Odiya BB++");

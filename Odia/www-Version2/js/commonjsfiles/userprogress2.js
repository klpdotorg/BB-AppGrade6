...
Game.userprogress2.prototype={
    ...
    gotoAddNSMCTopics:function(game){
        ...
        this.ratioandproportionTreeTxt = this.add.text(178, 520, "ଅନୁପାତ ଓ ସମାନୁପାତ "); // window.selctedLang.ratioandproportionTitle
    ...
    gotoAddALMCTopics:function(game){
        ...
        this.operationsTreeTxt = this.add.text(178, 200, "ଚଳନାଙ୍କ ଓ ସମୀକରଣ ");//window.selctedLang.algebraTitle

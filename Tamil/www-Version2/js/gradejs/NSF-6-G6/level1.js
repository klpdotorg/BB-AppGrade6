 ...
 getVoice:function(){
        ...
        switch(_this.qArrays[_this.no11])
        {
            ...
            case 10:if(_this.languageSelected =="ENG")
                    {
                         _this.src.setAttribute("src",  window.baseUrl+"questionSounds/NSF-6-G6/ENG/NSF-6-G6.mp3");
                    }
                    else if(_this.languageSelected =="HIN")
                    {
                        _this.src.setAttribute("src",  window.baseUrl+"questionSounds/NSF-6-G6/HIN/NSF-6-G6.mp3");
                    }
                    else if(_this.languageSelected =="KAN")
                    {
                         _this.src.setAttribute("src",  window.baseUrl+"questionSounds/NSF-6-G6/KAN/NSF-6-G6.mp3");
                    }
                    else if(_this.languageSelected =="GUJ")
                    {
                         _this.src.setAttribute("src",  window.baseUrl+"questionSounds/NSF-6-G6/GUJ/NSF-6-G6.mp3");
                    }
					else if(_this.languageSelected =="MAR")
                    {
                         _this.src.setAttribute("src",  window.baseUrl+"questionSounds/NSF-6-G6/MAR/NSF-6-G6.mp3");
                    }
					else if(_this.languageSelected =="TEL")
                    {
                         _this.src.setAttribute("src",  window.baseUrl+"questionSounds/NSF-6-G6/TEL/NSF-6-G6.mp3");
                    }
					else if(_this.languageSelected =="TM")
                    {
                         _this.src.setAttribute("src",  window.baseUrl+"questionSounds/NSF-6-G6/TM/NSF-6-G6.mp3");
                    }
					else if(_this.languageSelected =="URD")
                    {
                         _this.src.setAttribute("src",  window.baseUrl+"questionSounds/NSF-6-G6/URD/NSF-6-G6.mp3");
                    }
                  else if(_this.languageSelected =="ODI")
                    {
                        _this.src.setAttribute("src",  window.baseUrl+"questionSounds/NSF-6-G6/ODI/NSF-6-G6.mp3");

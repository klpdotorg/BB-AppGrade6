...
Game.GMAN_01_G6level1.prototype = {
    ...
    getVoice: function () {
        ...
        switch (_this.qArrays[_this.no11]) //_this.qArrays[_this.no11]
        {
            ...
            else if (_this.languageSelected == "TM") {
            ...
            case 7: if (_this.languageSelected == "ENG") {
                ...
                _this.src.setAttribute("src", window.baseUrl + "questionSounds/GMAN-01-G6/" + _this.languageSelected + "/GMAN-01-G6.mp3");
            }
            else if (_this.languageSelected == "URD") {
            ...
            case 11: if (_this.languageSelected == "ENG") {
                ...
                // 	else if(_this.languageSelected =="TM")
                //     {
                //          _this.src.setAttribute("src",  window.baseUrl+ "questionSounds/GMAN-01-G6/TM/sg21.2.5j.mp3");
                //     }
                // 	else if(_this.languageSelected =="URD")
                //     {
                //          _this.src.setAttribute("src",  window.baseUrl+ "questionSounds/GMAN-01-G6/URD/sg21.2.5j.mp3");

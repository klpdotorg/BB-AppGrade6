...
Game.NSF_1A_G6level1.prototype = {
    ...
    correctAns: function () {
        ...
        _this.time.events.add(1600, this.removeCelebration, this);
    ...
    removeCelebration: function () {
        ...
        if (_this.no1 < 3) {
            ...
            //this.stopAllVoice();
            this.state.start('NSF_1B_G6level1', true, false, _this.minutes, _this.seconds, _this.counterForTimer);
        }
    },
    ...
    getVoice: function () {
        ...
        if (_this.languageSelected == "ENG") {
            _this.src.setAttribute("src", window.baseUrl + "questionSounds/NSF-1A-G6/ENG/NSF-1-G6-a.mp3");
        }
        else if (_this.languageSelected == "HIN") {
            _this.src.setAttribute("src", window.baseUrl + "questionSounds/NSF-1A-G6/HIN/NSF-1-G6-a.mp3");
        }
        else if (_this.languageSelected == "KAN") {
            _this.src.setAttribute("src", window.baseUrl + "questionSounds/NSF-1A-G6/KAN/NSF-1-G6-a.mp3");
        }
        else if (_this.languageSelected == "GUJ") {
            _this.src.setAttribute("src", window.baseUrl + "questionSounds/NSF-1A-G6/GUJ/NSF-1-G6-a.mp3");
        }
        else if (_this.languageSelected == "MAR") {
            _this.src.setAttribute("src", window.baseUrl + "questionSounds/NSF-1A-G6/MAR/NSF-1-G6-a.mp3");
        }
        else if (_this.languageSelected == "TEL") {
            _this.src.setAttribute("src", window.baseUrl + "questionSounds/NSF-1A-G6/TEL/NSF-1-G6-a.mp3");
        }
        else if (_this.languageSelected == "TM") {
            _this.src.setAttribute("src", window.baseUrl + "questionSounds/NSF-1A-G6/TM/NSF-1-G6-a.mp3");
        }
        else if (_this.languageSelected == "URD") {
            _this.src.setAttribute("src", window.baseUrl + "questionSounds/NSF-1A-G6/URD/NSF-1-G6-a.mp3");
        }
        else if (_this.languageSelected == "ODI") {
            _this.src.setAttribute("src", window.baseUrl + "questionSounds/NSF-1A-G6/ODI/NSF-1-G6-a.mp3");
        }

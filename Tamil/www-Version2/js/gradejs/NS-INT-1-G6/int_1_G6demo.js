...
Game.NS_INT_1_G6demo.prototype = {
    ...
    q1S: function () {
        ...
        _this.time.events.add(1000, function ()    //* play audio after a small delay to synch with video.
        {
            _this.demoVideo_2.playbackRate = 1;
        })
    },
    ...
    showDemoVideo: function () {
        ...
        _this.demoVideo_1.onComplete.add(function ()    //* on completion of video1, play 2nd video.
        {
            ...
            _this.time.events.add(3900, function ()    //* play audio after a small delay to synch with video.
            {
                _this.q1Sound.play();
            })
        });

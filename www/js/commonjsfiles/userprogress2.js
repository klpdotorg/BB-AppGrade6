...
Game.userprogress2.prototype={
    ...
    gotoAddNSMCTopics:function(game){
        ...
        this.ratioandproportionTreeTxt = this.add.text(178, 520, "ରେଟିଓ ଏବଂ ଅନୁପାତ"); // window.selctedLang.ratioandproportionTitle
    ...
    gotoAddALMCTopics:function(game){
        ...
        this.operationsTreeTxt = this.add.text(178, 200, "ଭିନ୍ନ ଭିନ୍ନ ଏବଂ ସମୀକରଣ");//window.selctedLang.algebraTitle

...
Game.preloader_GMS_02_G6.prototype={
	preload:function(){
        ...
        this.load.image("butterfly",  window.baseUrl+ "assets/gradeAssets/GMS-02-G6/butterfly full.png");

        this.load.image("flower",  window.baseUrl+ "assets/gradeAssets/GMS-02-G6/flower full.png");

...
Game.downloadData.prototype = {
    ...
    create: function (game) {
        ...
        _this.basePath = cordova.file.externalRootDirectory + "Android/data/com.Akshara.MARBBplusplus/Files/Download/.gameFilesBB++V10_2/www/";

        _this.fullSize = 135693856;

        _this.zipFiles = [["Assets1.zip", 565373], ["Assets2.zip", 25572815], ["Assets4.zip", 66105124], ["questionSounds.zip", 39766797], ["sounds.zip", 3683747]];

        _this.counter = 0;
        _this.counter1 = 0;

        //39,372,442, 39,766,797
        // _this.language = "en";

        _this.fileCheck = [
            [_this.basePath + "questionSounds/ALAS-01-G6/MAR", localStorage.getItem("language") + "/questionSounds.zip"],
        ...
        var titleTxt = game.add.text(game.world.centerX, 45, "Marathi BB++");
    ...
    checkIfAllAssetsPresent: function () {
        if (_this.counter < _this.fileCheck.length)
            ...
            window.baseUrl = cordova.file.externalRootDirectory + "Android/data/com.Akshara.MARBBplusplus/Files/Download/.gameFilesBB++V10_2/www/";//cordova.file.externalDataDirectory + 

var nativeApp = 
{
	CloseApp:function() {
        ...
        ShareApp:function() {
            ...
            var options = {
              message: 'Check out this Amazing app \"BB++\",  that can help your child studying in class 6-8 learn Mathematics in the most amazing way, Download the android app now:', // not supported on some apps (Facebook, Instagram)
              subject: 'BB++', // fi. for email
              files: ['', ''], // an array of filenames either locally or remotely
              url: 'https://akshara.org.in/en/learning-app/',

...
Game.userprogress2.prototype={
    ...
    gotoAddNSMCTopics:function(game){
        ...
        this.ratioandproportionTreeTxt = this.add.text(160, 520, "गुणोत्तर आणि प्रमाण"); // window.selctedLang.ratioandproportionTitle
    ...
    gotoAddALMCTopics:function(game){
        ...
        this.operationsTreeTxt = this.add.text(160, 200, "चल आणि समीकरण");//window.selctedLang.algebraTitle

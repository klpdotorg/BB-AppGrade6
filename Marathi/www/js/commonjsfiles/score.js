...
Game.score.prototype={
	...
	getNextGame : function()
	{
		...
		if(_this.microConcepts == 'Number Systems')
		{
			...
			{
				case 'NS_OE_1A_G6': _this.state.start('preloader_fm_1',true,false);
									break;
				case 'NS_FM_1_G6': _this.state.start('preloader_hcf_1',true,false);
									break;
				case 'NS_HCF_1_G6': _this.state.start('preloader_prm_1',true,false);
									break;
				case 'NS_PRM_1_G6': _this.state.start('preloader_fm_3',true,false);
									break;
				case 'NS_FM_3_G6': _this.state.start('preloader_fm_4a',true,false);
									break;
				case 'NS_FM_4A_G6': _this.state.start('preloader_lcm_1',true,false);
									break;
				case 'NS_LCM_1_G6': _this.state.start('preloader_int_1',true,false);
									break;
	...
	getCurrentGame : function()
	{
		...
		switch(_this.game_id)
		{
			case 'NS_OE_1A_G6': _this.state.start('preloader_oe_1a',true,false);
								break;
			case 'NS_FM_1_G6': _this.state.start('preloader_fm_1',true,false);
								break;
			case 'NS_HCF_1_G6': _this.state.start('preloader_hcf_1',true,false);
								break;
			case 'NS_PRM_1_G6': _this.state.start('preloader_prm_1',true,false);
								break;
			case 'NS_FM_3_G6': _this.state.start('preloader_fm_3',true,false);
								break;
			case 'NS_FM_4A_G6': _this.state.start('preloader_fm_4a',true,false);
								break;
			case 'NS_LCM_1_G6': _this.state.start('preloader_lcm_1',true,false);
								break;
